...
export default function Footer() {
    return (
        <footer className="w-full relative overflow-x-clip text-sm pt-20 bg-gradient-to-b from-[#0F5F4F]/40 via-black/50 to-[#0F5F4F]/40 md:bg-none md:bg-[#020D2D] flex flex-col items-center justify-center">
            <div
            ...
            <div className="relative max-w-[1200px] md:mx-auto px-4 pt-20 md:px-20 overflow-y-clip md:overflow-visible mb-20 w-[calc(100%-2rem)] md:w-full border border-[#434343] rounded-3xl md:rounded-[40px] flex flex-col md:flex-row items-center md:justify-start gap-8 md:gap-16 py-8">
                ...
                <div className="relative w-full md:scale-[1.1] md:w-[280px] h-[320px] md:h-[350px] flex-shrink-0 flex items-center justify-center order-2 md:order-1">
                    ...
                    <Image
                        ...
                        width={280}
                        height={560}
                        className="absolute top-20 md:-top-12 left-1/2 md:left-35 -translate-x-1/2 md:-translate-x-1/2 md:ml-5 border-4 w-[10rem] md:w-[11rem] h-[14rem] md:h-[14rem] border-orange-400 rounded-2xl object-cover"
                    />
                    <Image
                        src="/images/logo.png"
                        alt="iPhone Frame"
                    ...
                    <div className="md:hidden flex flex-col gap-8">
                        ...
                        <div className="flex gap-4">
                            <div className="flex-1 flex flex-col gap-5">
                                <h3 className="text-white font-poppins font-semibold text-sm">Our Services</h3>
                                <div className="flex flex-col gap-3">
                                    <Link href="/online-order-management" className="text-[#E0E0E0] hover:text-white text-xs">
                                        Online Order Management
                                    </Link>
                                    <Link href="/video-transaction-analytics" className="text-[#E0E0E0] hover:text-white text-xs">
                                        Video + Transaction Analytics
                                    </Link>
                                    <Link href="/aibased-invoice-processing" className="text-[#E0E0E0] hover:text-white text-xs">
                                        AI-Based Invoice Processing
                                    </Link>
                                    <Link href="/surveillance-monitoring" className="text-[#E0E0E0] hover:text-white text-xs">
                            ...
                            <div className="flex-1 flex flex-col gap-5">
                                <h3 className="text-white font-poppins font-semibold text-sm">Quick Links</h3>
                                <div className="flex flex-col gap-3">
                        ...
                        <div className="flex gap-4">
                            <div className="flex-1 flex flex-col gap-5">
                                <h3 className="text-white font-poppins font-semibold text-sm">Important Information</h3>
                                <div className="flex flex-col gap-3">
                                    <Link href="/terms-and-conditions" className="text-[#E0E0E0] hover:text-white text-xs">
                                        Terms and Conditions
                                    </Link>
                                    <Link href="/privacy-policy" className="text-[#E0E0E0] hover:text-white text-xs">
                                        Privacy Policy
                                    </Link>
                                </div>
                            </div>
