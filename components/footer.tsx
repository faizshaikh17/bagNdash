    ...
    <footer className="w-full relative overflow-x-clip text-sm pt-20 bg-gradient-to-b from-transparent via-black/50 to-[#0F5F4F]/40 md:bg-none md:bg-[#020D2D] flex flex-col items-center justify-center">
      <div
        className="absolute lg:flex hidden w-[50%] h-80 opacity-60 pointer-events-none 
             right-0 bottom-80 
             bg-gradient-to-r from-green-400 via-teal-500 to-green-600 blur-[220px] z-0"
      />
      <div className="absolute md:hidden inset-0 opacity-55 flex items-start justify-center pointer-events-none z-0">
      ...
      {pathname !== '/pricing' && (
        <div className="relative max-w-[1200px] md:mx-auto px-4 pt-20 md:px-20 overflow-y-clip md:overflow-visible mb-20 w-[calc(100%-2rem)] md:w-full border border-[#434343] rounded-3xl md:rounded-[40px] flex flex-col md:flex-row items-center md:justify-start gap-8 md:gap-16 py-8">
          ...
          {/* Image Column */}
          <div className="relative w-full md:scale-[1.1] md:w-[280px] h-[320px] md:h-[350px] flex-shrink-0 flex items-center justify-center order-2 md:order-1 pointer-events-none">
            <Image
          ...
          <div className="relative flex flex-col z-50 items-start justify-start text-left max-w-[500px] w-full order-1 md:order-2 px-4 md:px-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full">
              ...
              <button className="px-6 py-3 rounded-md border border-white text-white font-semibold flex-1 sm:flex-none z-50 pointer-events-auto">
                Contact Sales
              </button>
            </div>
          </div>
          ...
          <Image
            ...
            width={180}
            height={80}
            className="-bottom-4 md:block hidden right-3 mb-4 absolute scale-[0.6] md:scale-[1] object-contain pointer-events-none"
          />
        </div>
      )}
          ...
          <div className="hidden md:flex md:flex-wrap md:justify-between md:gap-12">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3 z-50">
                <Link href="/online-order-management" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">
                  Online Order Management
                </Link>
                <Link href="/video-transaction-analytics" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">
                  Video + Transaction Analytics
                </Link>
                <Link href="/aibased-invoice-processing" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">
                  AI-Based Invoice Processing
                </Link>
                <Link href="/surveillance-monitoring" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">
                  Surveillance Monitoring
                </Link>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3 z-50">
                <Link href="/about-us" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">About</Link>
                <Link href="/pricing" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">Pricing</Link>
                <Link href="/contact" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">Contact</Link>
                <Link href="/video-transaction-analytics" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">Services</Link>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3 z-50">
                <Link href="/terms-and-conditions" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">
                  Terms and Conditions
                </Link>
                <Link href="/privacy-policy" className="text-[#E0E0E0] hover:text-white text-xs md:text-sm z-50 pointer-events-auto">
                  Privacy Policy
                </Link>
              </div>
            </div>
