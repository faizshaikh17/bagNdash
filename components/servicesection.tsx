        ...
        >
          {services.map((service, index) => (
            <div key={index} className="min-w-full flex justify-center">
              <div className="w-full max-w-[650px] h-[580px] border border-[#333] rounded-[20px] overflow-hidden bg-black/40 backdrop-blur-[20px]">
        ...
        {services.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all ${
              active === index ? "bg-gradient-to-r from-[#F462F3] to-[#7B50FE]" : "bg-[#4F4F4F]"
            }`}
          />
        ))}
      </div>
