...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[1300px] overflow-hidden bg-[#020D2D]">
      ...
      <div
        className="absolute inset-x-0 top-0 h-[screen] max-h-[1174px] opacity-50 pointer-events-none"
        style={{
          background:
      ...
      {/* Blue Ellipse */}
      <div
        className="absolute w-full max-w-6xl h-full max-h-6xl left-0 top-5 opacity-20 pointer-events-none"
        style={{
          background: '#295CFA',
          filter: 'blur(300px)',
        }}
      ...
      {/* Green Ellipse */}
      <div
        className="absolute w-full max-w-6xl h-full max-h-6xl left-[40%] top-8 opacity-25 pointer-events-none"
        style={{
          background: '#04FE9A',
          filter: 'blur(300px)',
        }}
      ...
      {/* Pink-Purple Glare (Left Mid) */}
      <div
        className="absolute w-full max-w-5xl h-full max-h-5xl left-20 -top-180 opacity-25 pointer-events-none"
        style={{
          background:
      ...
      {/* Content */}
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 space-y-10">
        {/* Hero Title */}
        <h1 className="max-w-6xl text-center text-4xl font-bold leading-[1.4] text-white md:text-5xl lg:text-[4.3rem]">
          One Platform. Three Powerful <br /> Solutions for Retailers.
        </h1>

        {/* Subtitle */}
        <p className="max-w-2xl text-center text-lg tracking-wide text-white/90">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row">
          ...
          <button className="group flex items-center justify-center gap-2 rounded-full py-2.5 tracking-wide text-sm font-semibold text-white transition-colors">
            Explore Solutions
            <ChevronRight
              size={18}
